            ...
            <form action="{{route('category.update', $category->id)}}" method="post">
                ...
                <div class="grid gap-4 mb-6">
                    <div class="mb-2">
                        ...
                        <input type="text" id="name" name="name" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg w-full @error('name') text-red-600 @enderror" value="{{old('name', $category->name)}}">
                        @error('name')
                    ...
                    <div class="mb-2">
                        ...
                        <textarea type="text" id="description" name="description" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg w-full @error('description') text-red-600 @enderror">{{old('description',$category->description)}}</textarea>
                    @error('description')
                        <p class="text-red-600">{{$message}}</p>
                    @enderror
                    </div>
